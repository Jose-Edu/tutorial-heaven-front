...
export function ThemeToggle() {
  ...
  function toggleTheme() {
    ...
    window.localStorage.setItem("tutorial-heaven-theme", nextIsDark ? "dark" : "light");
  }

  return (
    <button type="button" onClick={toggleTheme} aria-label="Alternar tema" aria-pressed={isDark} className="grid size-9 place-items-center rounded-md border border-border bg-surface text-muted transition hover:border-primary/50 hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring">
